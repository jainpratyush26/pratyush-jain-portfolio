...
const pins: LocationPin[] = [
  { name: "Mumbai", coords: [72.88, 19.08], type: "base", company: "Morgan Stanley", period: "2014–2016", tags: ["Base"], description: "Investment Banking analyst — M&A and capital markets across Indian financial services and consumer sectors." },
  { name: "Gurugram", coords: [77.03, 28.46], type: "base", company: "Kearney", period: "2016–2019", tags: ["Base", "Consulting"], description: "Strategy consulting — cost optimisation, supply chain, PE due diligence and growth strategy across Asia, MENA and India." },
  { name: "Berlin", coords: [13.4, 52.52], type: "base", company: "Delivery Hero", period: "2019–2023", tags: ["Base", "0→1", "1→10"], description: "Building and scaling businesses globally — logistics as a service, shops marketplace and dark store models across 4 continents." },
  { name: "Dubai", coords: [55.27, 25.2], type: "current", company: "noon Food", period: "2023–Present", tags: ["Current Base"], description: "Heading growth and P&L for UAE food delivery — driving customer acquisition, retention and margin across the platform." },
  ...
  { name: "Argentina", coords: [-63.62, -38.42], type: "operator", company: "Delivery Hero / PedidosYa", period: "2020–2021", tags: ["0→1", "1→10"], description: "Built logistics as a service from scratch and scaled a shops marketplace (grocery, pharmacy, beauty) to market leadership." },
