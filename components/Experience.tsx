...
const jobs = [
  ...
  },
  {
    ...
    bullets: [
      "Built Talabat Express — a rider-on-demand platform scaled across food, pharmacy and other use cases in MENA",
  ...
  },
  {
    ...
    bullets: [
      ...
      "PE due diligence for two major Indian retail investments",
      "Growth strategy for an oil & gas major",
    ],
    tag: "Consulting",
  },
  {
  ...
  return (
    <section id="experience" className="py-28 px-6 bg-[#f9f8f6]">
      <div className="max-w-5xl mx-auto">
              ...
              <div key={i} className="md:pl-10 relative group">
                ...
                <div className="bg-white border border-black/[0.07] rounded-2xl p-6 hover:border-indigo-200 hover:shadow-md transition-all duration-300 shadow-sm">
                  ...
                  <ul className="space-y-1.5">
                    {job.bullets.map((b, j) => (
                      <li key={j} className="text-black/50 text-sm flex gap-2 leading-relaxed">
        ...
        {/* ── World Map (part of Experience section) ── */}
        <WorldMap />
